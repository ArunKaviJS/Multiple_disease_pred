...
if selected=='Parkinsons Predictions':
    ...
    df=pd.read_csv(r"s3://multiple-disease-s3/parkinsons.csv")
...
if selected=='Kidney Prediction':
   ...
   df1=pd.read_csv(r"s3://multiple-disease-s3/Kidney.csv")
...
if selected=='Liver Prediction':
   ...
   df2=pd.read_csv(r"s3://multiple-disease-s3/liver.csv")
